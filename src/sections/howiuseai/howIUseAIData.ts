/**
 * HOW I USE AI 섹션에서 사용하는 프로젝트 데이터.
 */
...
export interface HowIUseAIProject {
    id: string;
    title: string;
    description: string;
    techStack: string[];
...
export const WORKFLOW_EXAMPLE: WorkflowExample[] = [
    {
        ...
        label: "사용자 명령",
        content:
            "Career 섹션 다음에 Projects 섹션을 만들어줘. " +
    ...
    },
    {
        ...
        content:
            ...
            "• Mobile: 네모 프로필 + 리스트\n" +
            "• 호버 시 확대, 클릭 시 사이트 이동\n\n" +
            "docs/design/projects-design.md에 초안을 작성했습니다.",
    },
    {
        role: "code",
        label: "코드일꾼",
        content:
            "구현 완료했습니다.\n" +
            "• projectsData.ts - 데이터 파일\n" +
            "• Projects.tsx - 메인 컴포넌트\n" +
            "• Projects.css - 궤도 회전 애니메이션\n\n" +
...
export const HOW_I_USE_AI_DATA: HowIUseAIProject[] = [
    {
        id: "projects",
        title: "인터랙티브 포트폴리오",
        description:
