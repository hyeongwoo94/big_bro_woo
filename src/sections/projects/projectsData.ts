/**
 * Projects 섹션에서 사용하는 포트폴리오 데이터.
 * 프로젝트 목록을 한곳에서 관리.
 * 정적 이미지 파일은 public/images/portfolio/ 에 두고, URL은 /images/portfolio/ 로 참조한다.
 */

/** public/images/portfolio/ 기준 정적 이미지 URL */
const projectsImage = (filename: string) => `/images/portfolio/${filename}`;

export type ProjectType = "work" | "toy";
...
export const PROJECTS_TYPE_LABEL: Record<ProjectType, string> = {
    work: "실무",
    toy: "토이",
};

/** 안쪽 궤도 포트폴리오 */
export const INNER_ORBIT_DATA: ProjectItem[] = [
    {
        id: "seoulmiz",
        title: "서울미즈병원",
        thumbnail: projectsImage("seoulmiz.png"),
    ...
    },
    {
        id: "bweye",
        title: "하늘안과",
        thumbnail: projectsImage("bweye.png"),
    ...
    },
    {
        id: "thebon",
        title: "더본안과",
        thumbnail: projectsImage("thebon.png"),
    ...
    },
    {
        id: "yale",
        title: "예일안과",
        thumbnail: projectsImage("yale.png"),
...
/** 바깥쪽 궤도 포트폴리오 */
export const OUTER_ORBIT_DATA: ProjectItem[] = [
    {
        id: "toy1",
        title: "업무관리 대시보드",
        thumbnail: projectsImage("toy1.png"),
