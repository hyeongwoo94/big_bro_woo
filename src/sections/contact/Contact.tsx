...
import { CONTACT_DATA, phoneDigits } from "./contactData";
import "./styles/Contact.css";

export default function Contact() {    const [isMobile, setIsMobile] = useState(false);
    ...
    return (
        <footer className="contact-footer" aria-label="연락처">
            <div className="contact-footer_cont">                <span className="contact-footer_copy">
